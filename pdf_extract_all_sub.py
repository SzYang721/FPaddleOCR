...
if __name__ == "__main__":
    input_dir = '/data/research_report/original_pdf/subset'
    output_dir = "home/songze/output_pdfs"
    for second_dir in os.listdir(input_dir):
        second_dir = os.path.join(input_dir,second_dir)
        for pdf_path in glob.glob(f"{second_dir}/*.pdf"):
            pdf_name = os.path.basename(pdf_path)[:-4]
